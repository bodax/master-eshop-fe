...
const CategoryPage = () => {
    ...
    React.useEffect(() => {
        ...
        dispatch(
            fetchCategoryProperties({url: location.pathname.replace('/group_', '')})
        );
    }, [location.pathname, language, navigate, dispatch]);
    ...
    }, [page, language, location.pathname, filteredManufacturers, params, dispatch]);
